# Contributing to SlackTube

👏🎉 First off all, Thanks for your interest in contributing to our project! 🎉👏

The following is a set of guidelines for contributing to SlackTube. These are
...
We use GitHub issues to track public bugs/enhancements. Report a new one by [opening a new issue](https://github.com/puttehi/slacktube/issues).
...
If you have any question feel free to contact us at Post an issue.
